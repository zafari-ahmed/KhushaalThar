 ...
 */
class LaboursLive extends MyActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('full_name, father_name, nicop, cnic, religion, dob, gender, mobile_number, martial_status, kids, block_2, village_id, address, tehsil_id, district_id, category_id, designation, remarks, thumb, avatar, drive, deo_id, status, createdOn', 'required'),
	...
	public function relations()
	{
		...
		return array(
			...
			'laborRequisitionsActive' => array(self::HAS_MANY, 'LaborRequisitions', 'labour_id','condition' => "`status` = 1"),
		);
	}
