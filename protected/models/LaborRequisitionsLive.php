...
/**
 * This is the model class for table "labor_requisitions".
 *
 * The followings are the available columns in table 'labor_requisitions':
 * @property integer $id
 ...
 * @property Labours $labour
 * @property ClientCompanyRequisitionDetails $requisition
 */
class LaborRequisitionsLive extends MyActiveRecord
{
	/**
	 ...
	 * @return LaborRequisitions the static model class
	 */
