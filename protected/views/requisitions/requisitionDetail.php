                  ...
                  <div class="x_content">
                    <div class="table-responsive">
                      ...
                      <table class="table table-striped table-bordered" id="attandanceSheet">
                        ...
                        <tbody>
                          <?php foreach($company->clientCompanyRequisitionDetails[0]->laborRequisitionsActiveComAtt as $lr):$lp=0; $lrDetail = LaborRequisitionDetails::model()->find('labor_requisition_id=:id',array(':id'=>$lr->id));?>
