                ...
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Requisition Detail
                      <a target="_blank" href="<?php echo Yii::app()->baseUrl?>/requisitions/Viewreport2/id/<?php echo @$detail_id?>/type/excel" class="pull-right no-print"><button type="button" class="btn btn-info btn-xs">Excel Report</button></a>&nbsp;
                      <a target="_blank" href="<?php echo Yii::app()->baseUrl?>/requisitions/Viewreport2/id/<?php echo @$detail_id?>/type/pdf" class="pull-right no-print"><button type="button" class="btn btn-info btn-xs">PDF Report</button></a>&nbsp;
                    </h2>
                  ...
                  <hr/>
                  <a href="javascript:void()" ><button id="allRows" type="button" class="btn btn-primary btn-xs">All</button></a>
                  <a href="javascript:void()" ><button id="pendingRow" type="button" class="btn btn-primary btn-xs">Pending</button></a>
                  <a href="javascript:void()" ><button id="acceptRow" type="button" class="btn btn-primary btn-xs">Accepted</button></a>
                  ...
                  <div class="x_content">
                    <div class="table-responsive">
                        ...
                        <tbody>
                          <?php foreach($model as $labor):?>
                            <tr class="even pointer tr_<?php echo $labor->status?>">
                              <td class="a-center">
                                <?php if($labor->status==1 || $labor->status==0 ){?>
                              ...
                              <td class=" last">
                                ...
                                <?php }?>
                                <a href="#"><button type="button" class="btn btn-info btn-xs reqstatusBtn" data-toggle="modal" data-target="#rejectModal" rel="<?php echo $labor->labour->id?>"><?php echo ($labor->status==1)?'Dismiss':'Reject'?></button></a>
                                <?php } else{?>
                      ...
                      <div class="col-md-12" style="margin-top:10px">
                        <button type="button" class="btn btn-info" id="reguisitionAttnBtn">Submit Attandance</button>
                        <button type="button" class="btn btn-danger" id="reguisitionDehireBtn">Dehire Applicants</button>
                        <button type="button" class="btn btn-success" data-toggle="modal" data-target="#acceptModal">Accept Applicants</button>
                      </div>
                    </div>
                  </div>
                </div>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="labreqacceptform" class="form-horizontal form-label-left">
            <input type="hidden" id="alabor_id" name="labor_id" class="labor_id">
            <input type="hidden" id="arequisition_id" name="requisition_id" value="<?php echo @$detail_id?>">
            <div class="form-group">
            ...
            <div class="form-group">
              ...
              <div class="col-md-6 col-sm-6 col-xs-12">
                <input type="text" id="asalary" name="salary" required="required" class="form-control col-md-7 col-xs-12">
              </div>
            </div>
        </form>
      </div>
...
<?php $reason = RejectReasons::model()->findAll();?>
<!-- Reject Modal -->
<div class="modal fade" id="rejectModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title" id="myModalLabel">Dismiss/Reject Applicant</h4>
      </div>
      <div class="modal-body">
              ...
              <div class="col-md-6 col-sm-6 col-xs-12">
                ...
                <select class="form-control" name="reason">
                  ...
                  <?php foreach($reason as $r):?>
                    <option value="<?php echo @$r->reason?>"><?php echo @$r->reason?></option>
                  <?php endforeach;?>
                </select>
              </div>
            </div>
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
        <button type="button" class="btn btn-primary" id="labreqrejectBtn">Dismiss/Reject</button>
      </div>
    </div>
  </div>
</div>