...
<html lang="en">
  ...
  <body class="nav-md" id="body">
      ...
      <div class="main_container">
        ...
        <footer>
          <div class="pull-right no-print">
            ©2017 - <?php echo date('Y')?> All Rights Reserved. KHUSHAAL THAR. Privacy and Terms
          </div>
          <div class="clearfix"></div>
        </footer>
        <!-- /footer content -->
    ...
    <script src="<?php echo Yii::app()->baseUrl?>/assets/js/jquery.blockUI.js"></script>
...
$('#training').click(function(){
  ...
  $('#datatableTra tbody').html('');
  $('#datatableTra').DataTable().destroy();
...
$('#no_training').click(function(){
  ...
  $('#datatableTra').DataTable({
      responsive: true,
      processing: true,
      serverSide: true,
      ajax: "<?php echo Yii::app()->baseUrl?>/training/gettraningapplicants?",
      ordering: true,
      aoColumnDefs: [
         { aTargets: [ 0 ], bSortable: true },
         { aTargets: [ 1 ], bSortable: false },
