...
<div class="email-content" style="border: 1px solid #dadedf;background: #fff;padding: 20px;border-radius: 0px 0px 4px 4px;border-top: 0px!important;">
        ...
        <p style="color: #666;">The requisition number <b><?php echo @$model[0]->requisition->requisition_code?></b> raised by <b><?php echo @$model[0]->requisition->person->name?></b> has been assigned required manpower. The manpower will be made available as per defined procedure and schedule.</p>
